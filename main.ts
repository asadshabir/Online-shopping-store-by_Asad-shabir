...
class userDetails {
    ...
    constructor(name:string,gmail:string,password:number){
        this.name =name
        this.gmail =gmail
        ...
        console.log("");
           ...
           const billing = await inquirer.prompt(
            ...
            if(confirm_Data.confirmitaion == chalk.bold.greenBright("Yes")){
                ...
                while(anotherCondition){const payment = await inquirer.prompt(
                    [
                        {
                            name : "method",
                            type : "list",
